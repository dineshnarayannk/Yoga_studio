  ...
  return (
    <AdminLayout title="Settings">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-2xl font-bold text-astrian-charcoal dark:text-gray-100">Settings</h1>
          <p className="text-sm text-gray-500 mt-1">Configure general studio settings.</p>
        </div>
      ...
      <div className="bg-white dark:bg-[#1c1f1d] border border-gray-200 dark:border-white/10 rounded-2xl shadow-sm p-12 text-center">
        ...
        <h3 className="text-lg font-medium text-astrian-charcoal dark:text-gray-100 mb-2">No settings found</h3>
